...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 h-screen overflow-auto">
      ...
      <div className="grid grid-cols-3 gap-4">
        {products.map(product => (
          <div key={product.id} className="border p-4">
            ...
            {!isAdmin && (
              <Link to="/placeOrder" className="btn btn-primary">
                Order
              </Link>
            )}
          </div>
      ...
      {/* Removed the Login as Admin button styling */}
      {showAddModal && (
          ...
          <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-8 rounded-md shadow-md">
              ...
              <form onSubmit={handleEditProduct}>
                ...
                <div className="flex justify-between">
                  <button type="submit" className="bg-blue text-white py-2 px-4 rounded hover:bg-blue">Edit Gift</button>
